...
export default function LinksPage({ currentProfile, onGoLists, onLogout, onOpenAdmin, onOpenMyPage }) {
  ...
  return <main className="app-page">
    ...
    <section className="content">
      ...
      <form className="link-add-form" onSubmit={addLink}><input value={name} onChange={(e) => setName(e.target.value)} placeholder="リンク名" /><input value={url} onChange={(e) => setUrl(e.target.value)} placeholder="https://example.com" /><button type="submit">追加</button></form>
